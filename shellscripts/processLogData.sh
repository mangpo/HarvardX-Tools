...
# argument 1: name of school on edX (e.g. BerkeleyX)
# argument 2: the day from which the log entries are to be processed 
#             (the first day of the week) in YYYY-MM-DD format.
# argument 3: the last day from which the log entries are to be processed 
